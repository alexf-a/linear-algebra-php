...
class Vector implements ArrayAccess {
	...
	/*
	 * Set value at index $offset to $value.
	 * @param int $offset.
	 * @param int|float $value.
	 * NOTE: Indices begin at 1.
	 */
	public function offsetSet($offset, $value){
		if ($offset > count($this->values)){
			throw new OutOfBoundsException("Index exceeds the dimensions of this vector");
		}
		if ($offset < 1) {
	...
	public function offsetUnset($offset){
		throw new DimensionException("Cannot reduce the dimensions of a vector.");
	}
	 ...
	 */
	public function scalar_multiply($a){
		for ($i = 0; $i < count($this->values); $i++){
 ...
 * NOTE: Please use getters to access specific elements (instead of indexing the data).
 */
class Matrix implements ArrayAccess {
	 ...
	 * @throws OutOfBoundsException if i <= 0. 
	 */
	 ...
	 * @throws OutOfBoundsException if j <= 0. 
	 */
	public function getColumn($j){
	 ...
	 for ($i = 0; $i < count($this->data); $i++){
	 	...
	 	array_push($result, $this->data[$i][$j-1];
	 }
	 ...
	 * @param int array|float array Array of values to change column to.
	 */
	...
	public function offsetUnset($offset){
		throw new DimensionException("Cannot change the dimensions of a Matrix");
	}
